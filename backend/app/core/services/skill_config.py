...
class SkillConfigManager:
    ...
    def _get_config_path(self) -> Path:
        """获取配置文件路径"""
        # 获取当前文件目录 (backend/app/core/services/)
        current_dir = Path(__file__).parent.absolute()
        # 向上查找 backend/app/modules/conversation/agent/config/skill_config.json
        config_path = current_dir.parent.parent.parent / "modules" / "conversation" / "agent" / "config" / "skill_config.json"
        return config_path
