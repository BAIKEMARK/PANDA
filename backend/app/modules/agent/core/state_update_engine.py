...
from backend.app.modules.agent.models.patient_state import PatientStateUpdate, CrisisEvent
...
class StateUpdateEngine:
    ...
    def __init__(self, config_path: str = None):
        ...
        if config_path is None:
            ...
            config_path = Path(__file__).parent.parent.parent.parent / "config" / "skill_config.json"
