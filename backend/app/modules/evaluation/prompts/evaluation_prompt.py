...
### 【自杀倾向识别规则】
当【会话危机检测】显示患者存在自杀倾向时，必须严格按以下标准评分：

| 患者状态 | 用户行为 | 评分等级 | 分数范围 |
|---------|---------|---------|---------|
| 有自杀倾向 | 点击报警 | 优秀 | 15-25分 |
| 有自杀倾向 | 未采取行动 | 不合格 | 0-14分 |
| 无自杀倾向 | - | 按下方原有标准 | - |

**重要说明**：
- 若患者有自杀倾向但用户未报警，必须在反馈中明确指出：这是严重的风险识别疏漏，护士未能识别患者的求救信号
- 若患者有自杀倾向且用户已报警，应在反馈中肯定其敏锐的风险识别能力和及时应对
