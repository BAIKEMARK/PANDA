...
CREATE TABLE `courses` (
  ...
  `created_by` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '创建人',
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `idx_level` (`level`),
...
INSERT INTO `courses` VALUES ('c-001','围产期抑郁概述','/courses/l1-overview.pdf',NULL,1,'L1','了解围产期抑郁的定义、流行病学数据和社会影响','2025-01-01 00:00:00',NULL,'shared','1.0.0',NULL,'published','2026-02-15 03:48:15','u-admin-001',NULL,'2026-02-15 04:00:38'),('c-002','围产期抑郁的识别与筛查','/courses/l1-screening.pdf',NULL,2,'L1','学习使用EPDS量表进行抑郁筛查的方法和技巧','2025-01-01 00:00:00',NULL,'shared','1.0.0',NULL,'published','2026-02-15 03:48:16','u-admin-001',NULL,'2026-02-15 04:00:42'),('c-003','基础沟通技巧','/courses/l1-communication.pdf',NULL,3,'L1','掌握与围产期女性沟通的基本原则和技巧','2025-01-01 00:00:00','org-hospital-001','private','1.0.0',NULL,'published','2026-02-15 03:48:18','u-admin-001',NULL,'2026-02-15 04:00:51'),('c-004','心理支持技术','/courses/l2-support.pdf',NULL,4,'L2','学习提供情感支持和心理疏导的专业技术','2025-01-01 00:00:00',NULL,'private','1.0.0',NULL,'published','2026-02-15 03:48:21','u-admin-001',NULL,'2026-02-15 03:48:21'),('c-005','危机干预基础','/courses/l2-crisis.pdf',NULL,5,'L2','识别自杀风险信号，掌握初步危机干预方法','2025-01-01 00:00:00',NULL,'private','1.0.0',NULL,'published','2026-02-15 03:48:21','u-admin-001',NULL,'2026-02-15 03:48:21'),('c-006','家庭支持系统评估','/courses/l2-family.pdf',NULL,6,'L2','评估和动员家庭支持资源的方法','2025-01-01 00:00:00',NULL,'private','1.0.0',NULL,'published','2026-02-15 03:48:20','u-admin-001',NULL,'2026-02-15 03:48:20'),('c-007','认知行为疗法入门','/courses/l3-cbt.pdf',NULL,7,'L3','CBT基本原理及在围产期抑郁中的应用','2025-01-01 00:00:00',NULL,'private','1.0.0',NULL,'published','2026-02-15 03:48:20','u-admin-001',NULL,'2026-02-15 03:48:20'),('c-008','药物治疗知识','/courses/l3-medication.pdf',NULL,8,'L3','了解围产期抑郁的药物治疗方案和注意事项','2025-01-01 00:00:00',NULL,'platform','1.0.0',NULL,'published','2026-02-15 03:48:19','u-admin-001',NULL,'2026-02-15 03:56:32'),('c-009','多学科协作','/courses/l4-mdt.pdf',NULL,9,'L4','与精神科、产科等多学科团队协作的方法','2025-01-01 00:00:00',NULL,'private','1.0.0',NULL,'published','2026-02-15 03:48:23','u-admin-001',NULL,'2026-02-15 03:48:23'),('c-010','案例督导与反思','/courses/l4-supervision.pdf',NULL,10,'L4','通过案例分析提升临床决策能力','2025-01-01 00:00:00',NULL,'private','1.0.0',NULL,'draft',NULL,NULL,NULL,'2026-02-10 17:58:55');
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `files` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '文件ID',
  `org_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '机构ID',
  ...
  `category` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'courseware' COMMENT '文件分类: courseware/document/image/video',
  `resource_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '关联资源类型: course/scenario/exam',
  `resource_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '关联资源ID',
  `uploaded_by` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '上传人',
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '文件描述',
  `status` enum('active','deleted') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'active' COMMENT '状态',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `idx_files_org_id` (`org_id`),
...
INSERT INTO `scenarios` VALUES ('s-001','产后情绪低落初筛','模拟与一位产后2周的新妈妈进行首次情绪筛查对话','你是一位产后2周的新妈妈，名叫小美，28岁，第一胎。你最近感觉很疲惫，睡眠不好，有时候会莫名其妙地想哭。你对照顾宝宝感到焦虑，担心自己做得不够好。你愿意和护士交流，但不太确定自己的感受是否正常。请根据护士的问题自然地回应，表达你的真实感受。','小美，28岁，已婚，大学本科学历，会计。丈夫在外地工作，婆婆帮忙照顾月子。顺产，母乳喂养。产前无抑郁史。','EPDS筛查,产后情绪,初次访谈',1,'产后2周','2025-01-01 00:00:00','org-hospital-001','shared','1.0.0',NULL,'published','2026-02-15 03:59:39','u-admin-001',NULL,'2026-02-15 03:59:39'),('s-002','轻度抑郁情绪支持','模拟与一位EPDS评分12分的产妇进行心理支持对话','你是一位产后6周的妈妈，名叫小丽，32岁。你的EPDS筛查评分是12分。你经常感到疲惫和无助，对很多事情失去兴趣，包括照顾宝宝。你有时会责怪自己不是一个好妈妈。你的丈夫很忙，你感到很孤独。你希望有人能理解你的感受。','小丽，32岁，已婚，研究生学历，教师（产假中）。丈夫是程序员，工作繁忙。剖宫产，混合喂养。孕期有轻度焦虑。','心理支持,情绪疏导,EPDS中度',2,'产后6周','2025-01-01 00:00:00',NULL,'shared','1.0.0',NULL,'published','2026-02-15 04:00:18','u-admin-001',NULL,'2026-02-15 04:00:18'),('s-003','家庭支持不足的产妇','模拟与一位缺乏家庭支持的产妇进行深入沟通','你是一位产后3个月的单亲妈妈，名叫小芳，26岁。你独自照顾宝宝，父母在外地，前男友不负责任。你感到非常疲惫和绝望，有时候会想\"如果没有我，宝宝会不会过得更好\"。但你很爱宝宝，不想伤害他。你需要帮助但不知道该向谁求助。','小芳，26岁，未婚单亲，高中学历，超市收银员（已辞职）。父母在农村，关系一般。顺产，母乳喂养。经济压力大。','家庭评估,社会支持,单亲妈妈,轻度自杀意念',3,'产后3个月','2025-01-01 00:00:00',NULL,'shared','1.0.0',NULL,'published','2026-02-15 04:00:18','u-admin-001',NULL,'2026-02-15 04:00:18'),('s-004','拒绝承认问题的产妇','模拟与一位否认自己有问题的产妇进行沟通','你是一位产后2个月的妈妈，名叫小雯，35岁，二胎。你是一个要强的人，认为自己必须做一个完美的妈妈。虽然你经常失眠、食欲不振、对大宝发脾气，但你坚持认为这些都是正常的，不需要帮助。你对护士的关心有些抵触，觉得她们小题大做。','小雯，35岁，已婚，硕士学历，企业高管。丈夫是医生。二胎剖宫产，大宝5岁。追求完美，不愿示弱。','否认心理,动机访谈,完美主义',3,'产后2个月','2025-01-01 00:00:00',NULL,'shared','1.0.0',NULL,'published','2026-02-15 04:00:19','u-admin-001',NULL,'2026-02-15 04:00:19'),('s-005','严重抑郁伴自杀风险','模拟与一位有自杀意念的产妇进行危机干预','你是一位产后4周的妈妈，名叫小琳，30岁。你感到极度绝望，觉得自己是个失败者，是家人的负担。你已经好几天没有好好吃饭和睡觉了。你有时会想到死亡，觉得如果自己不在了，大家都会轻松一些。你还没有具体的计划，但这些想法越来越频繁。你今天愿意和护士谈谈。','小琳，30岁，已婚，本科学历，全职妈妈。丈夫经常出差。难产后剖宫产，宝宝曾住NICU一周。有产前抑郁史，曾服用抗抑郁药。','危机干预,自杀评估,安全计划,紧急转介',5,'产后4周','2025-01-01 00:00:00','org-hospital-001','platform','1.0.0',NULL,'published','2026-02-15 04:00:20','u-admin-001',NULL,'2026-02-15 04:01:51');
...
-- Dump completed on 2026-06-08 13:53:09
